import { createApp } from "@travelese/app-store/db";
import {
  config,
  createSlackApp,
  slackInstaller,
} from "@travelese/app-store/slack";
          ...
          blocks: [
            {
              ...
              text: {
                type: "mrkdwn",
                text: "Hello there! 👋 I'm your new Travelese bot, I'll send notifications in this channel regarding new bookings and other important updates.\n\n Head over to the <slack://app?id=A07PN48FW3A&tab=home|Travelese Assistant> to ask questions.",
              },
            },
            {
              type: "divider",
            },
            {
              ...
              elements: [
                {
                  type: "mrkdwn",
                  text: "<https://app.travelese.ai/apps?app=slack&settings=true|Notification settings>",
                },
              ],
            },
          ],
