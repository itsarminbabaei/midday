...
export function transformOrderCancellation(
...
export function transformOrderChangeRequest(
  duffelOrderChangeRequest: DuffelOrderChangeRequest,
): OrderChangeRequest {
  return {
...
export function transformOrderChangeOffer(
  duffelOrderChangeOffer: DuffelOrderChangeOffer,
): OrderChangeOffer {
  return {
...
export function transformOrderChange(
...
export function transformPartialOfferRequest(
  duffelPartialOfferRequest: DuffelPartialOfferRequest,
): PartialOfferRequest {
  return {
...
export function transformAirlineInitiatedChange(
  duffelAirlineInitiatedChange: DuffelAirlineInitiatedChange,
): AirlineInitiatedChange {
  return {
